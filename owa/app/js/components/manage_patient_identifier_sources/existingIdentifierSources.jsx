...
export default class ExistingIdentifierSources extends Component {
  ...
  handleClick(event, identifierSource, index){
    if(event.target.name === 'configureButton' && identifierSource.class == "org.jnsereko.module.task1.SequentialIdentifierGenerator"){
      apiCall(
        null,
        'get', 
    ...
    }else if(event.target.name === 'configureButton' && identifierSource.class == "org.jnsereko.module.task1.RemoteIdentifierSource"){
      apiCall(
        null,
        'get', 
    ...
    }else if(event.target.name === 'configureButton' && identifierSource.class == "org.jnsereko.module.task1.IdentifierPool"){
      apiCall(
        null,
        'get', 
    ...
    }else if (event.target.name === 'viewButton' && identifierSource.class == "org.jnsereko.module.task1.SequentialIdentifierGenerator"){
      apiCall(
        null,
        'get', 
    ...
    else if (event.target.name === 'viewButton' && identifierSource.class == "org.jnsereko.module.task1.RemoteIdentifierSource"){
      apiCall(
        null,
        'get', 
        '/idgen/identifiersource/'+identifierSource.uuid+'/?v=custom:uuid,name,description,identifierType,url,user,password'
    ...
    else if (event.target.name === 'viewButton' && identifierSource.class == "org.jnsereko.module.task1.IdentifierPool"){
      apiCall(
        null,
        'get', 
  ...
  setSourceType(source){
    switch (source){
      case "org.jnsereko.module.task1.SequentialIdentifierGenerator":
        return "Local Identifier Generator";
        break;
      case "org.jnsereko.module.task1.RemoteIdentifierSource":
        return "Remote Identifier Source";
        break;
      case "org.jnsereko.module.task1.IdentifierPool":
