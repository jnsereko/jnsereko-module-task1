              ...
              <tr className="managePatientIdentifierSourcesRow">
                ...
                <td>
                  <Input type="select" className="managePatientIdentifierSourcesSelect" name="sourceType" id="sourceType"
                    ...
                    <option value="org.jnsereko.module.task1.SequentialIdentifierGenerator">Local Identifier
                      Generator
                    </option>
                    <option value="org.jnsereko.module.task1.RemoteIdentifierSource">Remote Identifier Source
                    </option>
                    <option value="org.jnsereko.module.task1.IdentifierPool">Local Pool of Identifiers</option>
                  </Input>
                </td>
              </tr>
              <tr className="managePatientIdentifierSourcesRow">
