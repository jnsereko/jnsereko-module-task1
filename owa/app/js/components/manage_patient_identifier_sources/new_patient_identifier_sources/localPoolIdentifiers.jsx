  ...
  handleSubmit(){
    ...
    apiCall(data, 'post', '/idgen/identifiersource?v=full').then((response) => {
      if( !response.error ) {
        ...
        response.class = "org.jnsereko.module.task1.IdentifierPool";
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <input id="refillWithScheduledTask1" name="refillWithScheduledTask" onChange={event => this.handleRadioChange("refill")} value="false" type="radio" /> When you request an identifier
              </td>
            </tr>
            <tr>
