          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <input id="refillWithScheduledTask1" name="refillWithScheduledTask" checked={this.state.refillWithScheduledTask === false ? true : false} value={this.state.refillWithScheduledTask} onChange={event => this.handleRadioChange("refill")} type="radio" /> When you request an identifier
              </td>
            </tr>
            <tr>
